...
class Perangkat extends CI_Controller
{
	...
	public function excel($kelompok = '')
	{
		...
		->setCellValue('B1',strtoupper('username'))
		->setCellValue('C1',strtoupper('nama desa'))
		->setCellValue('D1',strtoupper('nama'))
		->setCellValue('E1',strtoupper('tempat lahir'))
		->setCellValue('F1',strtoupper('tgl lahir'))
		->setCellValue('G1',strtoupper('kelamin'))
		->setCellValue('H1',strtoupper('alamat'))
		->setCellValue('I1',strtoupper('telepon'))
		->setCellValue('J1',strtoupper('agama'))
		->setCellValue('K1',strtoupper('status perkawinan'))
		->setCellValue('L1',strtoupper('pendidikan terakhir'))
		->setCellValue('M1',strtoupper('jamkes'))
		->setCellValue('N1',strtoupper('jabatan'))
		->setCellValue('O1',strtoupper('no sk'))
		->setCellValue('P1',strtoupper('sk penetapan kembali'))
		->setCellValue('Q1',strtoupper('tgl pelantikan'))
		->setCellValue('R1',strtoupper('akhir masa jabatan'))
		->setCellValue('S1',strtoupper('pelantik'))
		->setCellValue('T1',strtoupper('bengkok'))
		->setCellValue('U1',strtoupper('penghasilan'))
		->setCellValue('V1',strtoupper('riwayat pendidikan'))
		->setCellValue('W1',strtoupper('riwayat diklat'));
		...
		foreach($data as $key => $value) 
		{
			$spreadsheet->setActiveSheetIndex(0)
			->setCellValue('A'.$i,$j)
			->setCellValue('B'.$i,strtoupper($value['username']))
			->setCellValue('C'.$i,strtoupper($value['nama_desa']))
			->setCellValue('D'.$i,strtoupper($value['nama']))
			->setCellValue('E'.$i,strtoupper($value['tempat_lahir']))
			->setCellValue('F'.$i,strtoupper($value['tgl_lahir']))
			->setCellValue('G'.$i,strtoupper($kelamin[$value['kelamin']]))
			->setCellValue('H'.$i,strtoupper($value['alamat']))
			->setCellValue('I'.$i,strtoupper($value['telepon']))
			->setCellValue('J'.$i,strtoupper($agama[$value['agama']]))
			->setCellValue('K'.$i,strtoupper($status_perkawinan[$value['status_perkawinan']]))
			->setCellValue('L'.$i,strtoupper($pendidikan_terakhir[$value['pendidikan_terakhir']]))
			->setCellValue('M'.$i,strtoupper($value['jamkes']))
			->setCellValue('N'.$i,strtoupper($jabatan[$value['jabatan']]))
			->setCellValue('O'.$i,strtoupper($value['no_sk']))
			->setCellValue('P'.$i,strtoupper($value['sk_penetapan_kembali']))
			->setCellValue('Q'.$i,strtoupper($value['tgl_pelantikan']))
			->setCellValue('R'.$i,strtoupper($value['akhir_masa_jabatan']))
			->setCellValue('S'.$i,strtoupper($value['pelantik']))
			->setCellValue('T'.$i,strtoupper($value['bengkok']))
			->setCellValue('U'.$i,strtoupper($value['penghasilan']))
			->setCellValue('V'.$i,strtoupper($value['riwayat_pendidikan']))
			->setCellValue('W'.$i,strtoupper($value['riwayat_diklat']));
			$i++;
			$j++;
		}
