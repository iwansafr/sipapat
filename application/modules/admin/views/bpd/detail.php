...
echo '<a class="btn btn-warning btn-sm" href="'.base_url('admin/perangkat/list').'"><i class="fa fa-arrow-left"></i> kembali</a>';
if(!empty($id) && is_numeric($id))
{
	...
	$form->setHeading('Detail BPD '.@$pengguna['username']);
	$form->setEditStatus(FALSE);
	$form->addInput('kelompok','static');
	$form->setValue('kelompok',2);
