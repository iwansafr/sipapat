...
$form->setHeading('<a href="'.base_url('admin/bpd/edit').'" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i></a>');
$form->setWhere(' kelompok = 2 '.$ext);
...
$form->setLink('id',base_url('admin/bpd/detail'),'id');
$form->setClearGet('id');
...
$form->setFormName('bpd_form');

$form->setUrl('admin/bpd/clear_list');
$form->setEdit(TRUE);
$form->setDelete(TRUE);
$form->form();
