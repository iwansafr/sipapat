...
?>
<form action="<?php echo base_url('admin/dilan/surat_list') ?>" method="get">
	<div class="form-group">
		<label>sortir perdesa <?php echo !empty(@$_GET['kec']) ? 'di kecamatan '.strtoupper($_GET['kec']) : ''; ?></label>
		<?php !empty($_GET['kec']) ? msg('jika tidak memilih salah satu desa maka akan menampilkan semua data di kecamatan '.$_GET['kec'],'warning') : ''; ?>
	</div>
