...
$statistik = $this->statistik_model->getStatistikPekerjaan();
?>
<div class="box">
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
            <canvas id="pekerjaanChart" style="height:250px"></canvas>
            </div>
            <!-- /.box-body -->
        </div>
    </div>
...
$script = "
$(function(){
    var pieChartCanvas = $('#pekerjaanChart').get(0).getContext('2d')
