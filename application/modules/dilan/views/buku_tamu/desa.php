		...
		<div class="container d-flex align-items-center">
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li><a class="nav-link scrollto" onclick="formFocus()" href="#startForm">Buku Tamu</a></li>
					<li><a class="getstarted scrollto" onclick="formFocus()" href="#startForm">Mulai</a></li>
				</ul>
			...
			<div class="row">
				<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
					...
					<div class="d-flex justify-content-center justify-content-lg-start">
						<a href="#startForm" class="btn-get-started scrollto" onclick="formFocus()">Isi Buku Tamu</a>
